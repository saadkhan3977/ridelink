...
<head>
  <title>Ride Link || Login Page</title>
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Rider Dashboard</h1>
                  </div>
                  <div class="logmod__container">
                    ...
                    <div class="tab-content">
                      ...
                      <div  class="tab-pane fade show" id="register"><br>
                        ...
                        <div class="logmod__form">
                          <form method="POST" id="vform" action="{{ route('rider_register.submit') }}">
                            @csrf
                            <input type="hidden" name="roles[]" value="rider">
                            <div class="sminputs">
                              <div class="input full">
